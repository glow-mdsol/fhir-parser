...
tpl_codesystems_source = (
    "template-codesystems.py"
)
# the filename to use for the generated code systems and value sets (in `tpl_resource_target`)
...
# target file name pattern for unit tests; the one placeholder (`{}`) will be the class name
